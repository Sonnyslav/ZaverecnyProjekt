...
namespace InsuranceCompany.Data.Migrations
{
    ...
    [Migration("20240221132637_UpdateofEvents")]
    partial class UpdateofEvents
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("InsuranceCompany.Models.Insurance", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("InsuranceCompany.Models.InsuredEvent", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("InsuranceCompany.Models.Insurance", b =>
                {
                    b.HasOne("InsuranceCompany.Models.Client", "InsuredPerson")
                        .WithMany()
                        .HasForeignKey("InsuredPersonId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("InsuranceCompany.Models.Client", "Insurer")
                        .WithMany()
            ...
            modelBuilder.Entity("InsuranceCompany.Models.InsuredEvent", b =>
                {
                    ...
                    b.HasOne("InsuranceCompany.Models.Insurance", "Insurance")
                        .WithMany()
